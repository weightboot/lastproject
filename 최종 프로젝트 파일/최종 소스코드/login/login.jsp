...
<%
    ...
    try {
        ...
        if (rs.next()) {
            ...
            // 로그인 성공 시 리다이렉트한다.
            //response.sendRedirect("http://localhost:42888/test2/login/login_success.html");//내부 확인용
            response.sendRedirect("http://172.20.221.166:42888/test2/login/login_success.html");//외부 접속용
        } else {
            // 로그인 실패 시 리다이렉트한다.
